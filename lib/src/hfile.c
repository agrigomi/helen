...
void *hf_add(_hf_context_t *p_cxt, const void *key, int sz_key, void *data, unsigned int sz_data) {
	void *r = NULL;
	_hf_rec_hdr_t rh;
...
void *hf_get(_hf_context_t *p_cxt, const void *key, int sz_key, unsigned int *sz_data) {
	void *r = NULL;
